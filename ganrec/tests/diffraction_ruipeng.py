...
def main():
    ...
    fname_data = '/nsls2/data/staff/xyang4.old/data/diffraction_ruipeng/RLi_sbcc_saxs/test3_0_degree.tiff'
    fname_mask = '/nsls2/data/staff/xyang4.old/data/diffraction_ruipeng/mask_crop_nor.tiff'
    ...
    dxchange.write_tiff(rec.reshape((px, px)), '/nsls2/data/staff/xyang4.old/data/diffraction_ruipeng/RLi_sbcc_saxs/crop/results/phase_log50', overwrite=True)
    dxchange.write_tiff(abs.reshape((px, px)), '/nsls2/data/staff/xyang4.old/data/diffraction_ruipeng/RLi_sbcc_saxs/crop/results/abs_log50', overwrite=True)
