...
from ganrectf.models import make_generator, make_discriminator, diffusion_model
from ganrectf.utils import RECONmonitor, ffactor, pad_to_divisible_by_8
...
def generate_ts(time_steps, num):
    return np.random.randint(0, 100, size=num)
...
class GANtomo:
    def __init__(self, prj_input, angle, **kwargs):
        ...
        tf_configures()
        self.prj_input = pad_to_divisible_by_8(prj_input)
