...
def generator_loss(fake_output, img_target, img_pred, recon, l1_ratio):
    ...
    # Total generator loss: combine adversarial, reconstruction, SSIM, and TV losses. The weights can be adjusted as needed.
    # The working version for most of the cases:
    ...
    # gen_loss = adv_loss + \
    #     abs_loss*0.01 + \
    #     ssim_component*100 + 1e-5 * tv_component + \
    #     0.05 * mean_match(img_target, img_pred) + \
    #     0.05 * variance_floor(img_pred)
